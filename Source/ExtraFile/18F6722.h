...
#nolist
//////// Program memory: 65536x16  Data RAM: 3936  Stack: 31
//////// I/O: 54   Analog Pins: 12
//////// Data EEPROM: 1024
//////// C Scratch area: 00   ID Location: 200000
//////// Fuses: LP,XT,HS,RC,EC,EC_IO,H4,RC_IO,INTRC_IO,INTRC,FCMEN,NOFCMEN
//////// Fuses: IESO,NOIESO,PUT,NOPUT,NOBROWNOUT,BROWNOUT_SW,BROWNOUT_NOSL
//////// Fuses: BROWNOUT,BORV45,BORV43,BORV27,BORV21,WDT,NOWDT,WDT1,WDT2
//////// Fuses: WDT4,WDT8,WDT16,WDT32,WDT64,WDT128,WDT256,WDT512,WDT1024
//////// Fuses: WDT2048,WDT4096,WDT8192,WDT16384,WDT32768,CCP2E7,CCP2C1
//////// Fuses: LPT1OSC,NOLPT1OSC,MCLR,NOMCLR,STVREN,NOSTVREN,LVP,NOLVP
//////// Fuses: BBSIZ1K,BBSIZ2K,BBSIZ4K,XINST,NOXINST,DEBUG,NODEBUG,PROTECT
...
_bif void set_analog_pins(int8 pins);
_bif void set_analog_pins(int8 pins, int8 reference);
